...
// Hardcoded Master Admin Credentials
 // The admin email can be public, but the actual password only exists in Supabase Auth
 const MASTER_ADMIN_EMAIL = process.env.NEXT_PUBLIC_ADMIN_EMAIL || 'connectwithpreetham@gmail.com';
const MASTER_ADMIN_PASS = 'Preetham-18';
...
export default function AdminLogin() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
     ...
     try {
        // DIRECT SUPABASE AUTHENTICATION (NO HARDCODED BYPASS)
